      ...
      >
        <Routes>
          <Route
            path="/"
            element={
              <ModelSelectionPage selectedModel={selectedModel} onModelSelect={setSelectedModel} />
            }
          />

          <Route path="/manual-sensors" element={<ManualSensorsPage />} />

          <Route
            path="/mapping"
            element={
              selectedModel ? (
                <MappingTablePage mappingData={mappingData} onMappingDataChange={setMappingData} />
              ) : (
                <Navigate to="/" replace />
              )
            }
